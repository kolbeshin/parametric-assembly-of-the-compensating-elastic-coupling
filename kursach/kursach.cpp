...
// kursach.cpp : Defines the class behaviors for the application.
//
...
// The one and only CkursachApp object

CkursachApp theApp;


// CkursachApp initialization
